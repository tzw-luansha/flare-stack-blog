...
export function RegisterPage({
  ...
  if (registerForm.isSuccess) {
    return (
      <div className="glass-card p-8 md:p-12 text-center space-y-8 animate-in fade-in duration-500">
      ...
      <div className="glass-card p-8 md:p-10 space-y-10">
        ...
        <div className="text-center pt-4">
          <p className="text-[10px] font-mono text-muted-foreground/50 tracking-wider">
            ...
            <Link
              to="/login"
              className="text-accent hover:opacity-80 transition-opacity ml-1"
            >
