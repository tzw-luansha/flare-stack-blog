        ...
        <div className="flex flex-col items-center justify-center space-y-8 py-8">
          ...
          {status === "SUCCESS" && (
            <div className="text-center space-y-8 animate-in fade-in duration-500">
              <CheckCircle2 className="w-16 h-16 mx-auto text-accent animate-in zoom-in duration-500" />
          ...
          {status === "ERROR" && (
            <div className="text-center space-y-8 animate-in fade-in duration-500">
              ...
              <div className="space-y-4 w-full">
                ...
                <Link
                  to="/login"
                  className="block w-full text-center text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground/60 hover:text-accent transition-colors"
                >
