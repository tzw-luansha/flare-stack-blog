  ...
  return (
    ...
    >
      ...
      {session ? (
        ...
        <div className="glass-card py-12 flex flex-col items-center justify-center gap-4 text-center">
          ...
          <Link to="/login">
            <Button
              variant="outline"
              className="glass-card h-10 px-6 text-[10px] uppercase tracking-[0.25em] font-bold border-0 bg-transparent hover:bg-white/10 hover:text-white transition-all"
            >
      ...
      {hasNextPage && (
        <div className="flex justify-center pt-8">
          <Button
            ...
            className="glass-card px-8 py-5 text-[10px] uppercase tracking-[0.2em] font-bold border-0 bg-transparent hover:bg-white/10 hover:text-white transition-all"
          >
