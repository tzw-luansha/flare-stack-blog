...
const ToolbarButton: React.FC<ToolbarButtonProps> = ({
  ...
  <button
    onClick={onClick}
    className={clsx(
      "p-1.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 group relative",
      isActive
...
const CommentEditorToolbar: React.FC<CommentEditorToolbarProps> = ({
  ...
  return (
    <div className="glass-card flex items-center gap-1 p-1 border-0 bg-white/5 backdrop-blur-sm rounded-xl">
      {/* Formatting */}
      <ToolbarButton
