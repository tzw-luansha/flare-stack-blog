import ZoomableImage from "@/features/theme/themes/glass/components/content/zoomable-image";
...
export function ImageDisplay({
  ...
  return (
    <figure className="my-12 group relative block">
      {/* Image Container */}
      <div className="relative overflow-hidden rounded-2xl border border-white/10 dark:border-white/5 glass-card hover:translate-y-0">
        <ZoomableImage
          src={src}
          alt={alt}
          width={width}
