...
export default function ZoomableImage({
  ...
  // Handle SSR hydration when image is already loaded
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Hover Hint Overlay - Glass style */}
        {showHint && (
          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/2 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100 pointer-events-none">
            <div className="bg-background/70 backdrop-blur-md px-3 py-1.5 rounded-xl border border-white/10 dark:border-white/5 transition-all duration-500">
