...
export function Navbar({
  ...
  return (
    <>
      <header
        className={`glass-nav fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${
          isScrolled ? "scrolled" : ""
        }`}
      >
        <div className="max-w-5xl mx-auto w-full px-6 md:px-8 flex items-center justify-between h-16 md:h-20">
          {/* Left: Brand */}
          <Link to="/" className="group select-none">
            <span className="font-serif text-xl font-bold tracking-tighter text-foreground/90 transition-colors group-hover:text-glass-accent">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3 pl-2">
              ...
              <button
                ...
                type="button"
              >
                <span className="w-5 h-px bg-foreground/70 transition-all group-hover:w-3" />
                <span className="w-5 h-px bg-foreground/70 transition-all group-hover:w-6" />
              </button>
            </div>
          </div>
        </div>
